(function(angular){
  ...
  app.controller('goodslistCtrl',['$scope',function($scope){
    // 商品列表数据
    var data = obj_goodsListData = [
          {
    ...
    $scope.getnewData = function(){
      //假设已经得到数据
      $scope.obj_goodsListData = data;
      //加载数据完成后，要通知ion-refresher标签隐藏动画
    ...
    $scope.loadMoreData = function(){
      //假设更多数据已经得到
      $scope.obj_goodsListData = $scope.obj_goodsListData.concat(data);
